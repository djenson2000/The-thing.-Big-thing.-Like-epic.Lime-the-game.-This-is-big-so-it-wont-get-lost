Menu_To_Level_One_BUTTON = {
    name = "MenuToLevelone",
    x = 650, -- The x-coordinate of the button's top-left corner
    y = 500, -- The y-coordinate of the button's top-left corner
...
Menu_to_settings_BUTTON = {
    name = "MenuTosettings",
    x = 900, -- The x-coordinate of the button's top-left corner
    y = 500, -- The y-coordinate of the button's top-left corner
    width = 200, -- The width of the button
    height = 50, -- The height of the button
    color = { 0.5, 0.5, 0.5 }, -- The color of the button (gray)
...
Menu_label_BUTTON = {
    name = "Main Menu text",
    x = 700, -- The x-coordinate of the button's top-left corner
    y = 100, -- The y-coordinate of the button's top-left corner
    width = 400, -- The width of the button
